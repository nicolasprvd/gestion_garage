...
@XmlRootElement(name = "getVehiculesResponse", namespace = "http://services/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getVehiculesResponse", namespace = "http://services/")
public class GetVehiculesResponse {
